      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="/" class="text-white h2 mb-0">UGFP2</a></h1>
          </div>
          ...
          <div class="col-md-10">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-10 text-center">
                <h1 class="mb-0 site-logo"><a href="/" class="text-white h2 mb-0"><img src ="{{ asset('/images/logo.png') }}" style="width:100px;height:120px;"></a></h1>

                <h1 data-aos="fade-up" class="animated bonuce">UGFP2</h1>
                <p data-aos="fade-up" class=" w-75 mx-auto">Unité de Recherche de Génomique Fonctionnelle et Physiologie des Plantes  <span class="typed-words"></span></p>
              </div>
            </div>
