...
<link rel="stylesheet" type="text/css" href="{{ asset('/css/home.css') }}" />
  ...
  <body>
    ...
    <div class="site-wrap">
      ...
      <div class="site-blocks-cover inner-page-cover overlay" style="background-image:url('{{ asset('/images/image_1.jpg') }}');" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
              @yield('content')
            </div>
          </div>
